...
This is a data analysis project I made while learning data analysis, moving from a logistics job into data analytics. I wanted to check how the cesarean section (C-section) rate changed in Poland over the last 15 years, if it's different between regions, and if hospital size has anything to do with it.
